...
class InventoryFoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory_food" do
    assert_difference("InventoryFood.count") do
      post inventory_foods_url, params: { inventory_food: { Quantity: @inventory_food.Quantity, food_id: @inventory_food.food_id, inventory_id: @inventory_food.inventory_id } }
    end
  ...
  test "should update inventory_food" do
    patch inventory_food_url(@inventory_food), params: { inventory_food: { Quantity: @inventory_food.Quantity, food_id: @inventory_food.food_id, inventory_id: @inventory_food.inventory_id } }
